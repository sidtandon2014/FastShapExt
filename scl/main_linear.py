...
def parse_option():
    ...
    parser.add_argument('--ckpt', type=str, default='./save/SupCon/cifar10_models/SupCon_cifar10_resnet50_lr_0.05_decay_0.0001_bsz_256_temp_0.07_trial_0/ckpt_epoch_150.pth',
